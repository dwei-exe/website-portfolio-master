      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-12 md:px-12 lg:px-8">
        ...
        <div className="relative overflow-hidden w-full">
          ...
          <div className="relative w-full">
            {/* Add gradient masks */}
            <div className="absolute top-0 left-0 h-full w-[100px] bg-gradient-to-r from-[#ffffff] to-transparent z-10"></div>
            <div className="absolute top-0 right-0 h-full w-[100px] bg-gradient-to-l from-[#ffffff] to-transparent z-10"></div>
